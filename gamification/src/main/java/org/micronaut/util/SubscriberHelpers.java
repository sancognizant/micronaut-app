...
public final class SubscriberHelpers {
     ...
     */
    public static class ScoreCardSubscriber extends OperationSubscriber<ScoreCard> {

        @Override
        public void onNext(final ScoreCard document) {
            super.onNext(document);
        }
    }

    /**
     * A Subscriber that collect Document
     */
     ...
     * A Subscriber that collect Document
     */
    public static class ObjectSubscriber extends OperationSubscriber<Object> {

        @Override
        public void onNext(final Object document) {
            super.onNext(document);
        }
    }
